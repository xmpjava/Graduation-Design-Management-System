...
import sqgxy.xmp.graduation.entity.Admin;
import sqgxy.xmp.graduation.entity.BaseDept;
import sqgxy.xmp.graduation.entity.BaseMajor;
...
import sqgxy.xmp.graduation.service.AdminService;
import sqgxy.xmp.graduation.service.BaseDeptService;
import sqgxy.xmp.graduation.service.BaseMajorService;
...
public class AdminController {
	 ...
	 * 向下载文件管理跳转
	 */
	@RequestMapping(value = "/admin/gofilelist.action")
	public ModelAndView gofilelist() {
		ModelAndView mv = new ModelAndView();
		mv.setViewName("views/user/admin/gofilelist");
		return mv;
	}
	 ...
	 * 向通知公告管理跳转
	 */
	@RequestMapping(value = "/admin/notice.action")
	public ModelAndView gonotice() {
		ModelAndView mv = new ModelAndView();
		mv.setViewName("views/user/admin/notice");
		return mv;
	}
